...
// Layout asserts skipped: _G_fpos_t is glibc-specific, unused by whisper API, absent on Windows.
const _: () = {};
...
// Layout asserts skipped: _G_fpos64_t is glibc-specific, unused by whisper API, absent on Windows.
const _: () = {};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    // Layout asserts skipped: _IO_FILE is glibc-specific, unused by whisper API, absent on Windows.
};
